...
class Juicy_Geoip_Block_Countrydefine extends Mage_Adminhtml_Block_System_Config_Form_Field_Array_Abstract
{
    ...
    {           
        ...
        if($columnName === "currencyCode"){
            ...
            return '<select style="width:140px" name="' . $inputName . '">'.$currencyStr.'</select>';
            ...
            return '<select style="width:140px" name="' . $inputName . '">'.$countryStr.'</select>';
            ...
            return '<select style="width:140px" name="' . $inputName . '">'.$storeStr.'</select>';
        }else{
