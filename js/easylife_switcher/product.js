    ...
    getOptionText: function(elem, value, config){
        ...
        switch (config.type) {
            ...
            case 'product_images':
                ...
                if (productId && (image = this.getConfigValue(images, productId, false)) && (description = this.getConfigValue(descriptions, productId, false) )) {
                    text = '<div class="attributeOption">'
                            + text +'<span class="imgUrl hidden">' + image + '</span>'+
